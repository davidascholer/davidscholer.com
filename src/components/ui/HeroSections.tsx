...
export function IntroHeroSection() {
  return (
    <div className="relative mx-auto flex flex-1 flex-col items-center justify-center px-1 lg:px-14">
...
export function VerticalListHeroSection({
  items,
  header,
}: {
  items: string[];
  ...
  return (
    <div className="relative mx-auto flex flex-1 flex-col items-center justify-start px-14">
      ...
      <div className="p-8" ref={componentRef}>
        {header && (
          <h1 className="relative z-10 mx-auto text-center text-2xl font-bold text-slate-700 sm:text-3xl md:text-4xl lg:text-5xl dark:text-slate-300">
            <motion.span
              // initial={{ opacity: 0, filter: "blur(4px)", y: 10 }}
              animate={controls}
          ...
          {items.map((word, index) => (
            <div key={index}>
              <motion.span
                ...
                transition={{
                  duration: 0.3,
                  delay: (header ? index + 1 : index) * 0.15,
                  ease: "easeInOut",
                }}
...
//   return (
//     <div className="relative mx-auto my-10 flex flex-1 max-w-7xl flex-col items-center justify-center">
//       <Navbar />
//       <div className="absolute inset-y-0 left-0 h-full w-px bg-neutral-200/80 dark:bg-neutral-800/80">
